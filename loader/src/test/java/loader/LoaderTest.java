...
class LoaderTest {
    ...
    /**
     * loadTripleTable loads the particular input testing graph the real triple
     * table loader cannot be tested in absence of hive support.
     */
    ...
    void verticalPartitioningTest() {
        final VerticalPartitioningLoader vp_loader = new VerticalPartitioningLoader("", "testingDB", "triples", spark, false, "a.txt", "b.txt", false, 0.25);
        vp_loader.load();
